...
async def Handle_StartMsg(bot:Client, msg:Message):
    ...
    if msg.chat.type == enums.ChatType.SUPERGROUP and not await db.is_user_exist(msg.from_user.id):
        ...
        btn = [
            ...
            [InlineKeyboardButton(text='💻 Channel', url='https://t.me/Anime_Madness')]
        ]
        ...
        btn = [
            ...
            [InlineKeyboardButton(text='📢 Updates', url='https://t.me/Madness_Association'), InlineKeyboardButton(text='💻 Channel', url='https://t.me/Anime_Madness')]
        ]
